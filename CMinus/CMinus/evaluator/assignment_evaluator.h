...
namespace cminus::evaluator{
	...
	protected:
		...
		virtual std::shared_ptr<memory::reference> assign_address_(logic::runtime &runtime, std::shared_ptr<memory::reference> destination, std::shared_ptr<memory::reference> source) const;

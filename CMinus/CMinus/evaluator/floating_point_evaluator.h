...
namespace cminus::evaluator{
	...
	protected:
		virtual std::shared_ptr<memory::reference> assign_(logic::runtime &runtime, std::shared_ptr<memory::reference> destination, std::shared_ptr<memory::reference> source) const override;

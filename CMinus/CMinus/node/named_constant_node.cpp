...
void cminus::node::named_constant::print(io::writer &writer, bool is_qualified) const{
	switch (type_){
	case constant_type::false_:
		writer.write_buffer("false", 5u);
		break;
	case constant_type::true_:
		writer.write_buffer("true", 4u);
		break;
	case constant_type::indeterminate:
		writer.write_buffer("indeterminate", 13u);
		break;
	case constant_type::nullptr_:
		writer.write_buffer("nullptr", 7u);
		break;
	case constant_type::nan_:
		writer.write_buffer("NaN", 3u);
		break;
	default:
		break;
	}
...
std::shared_ptr<cminus::memory::reference> cminus::node::named_constant::evaluate(logic::runtime &runtime) const{
	...
	case constant_type::false_:
		return std::make_shared<memory::reference_with_value<constant_type>>(
			runtime.global_storage_->find_type(logic::type::primitive::convert_id_to_string(logic::type::primitive::id_type::bool_), false),
			0u,
	...
	case constant_type::nullptr_:
		return std::make_shared<memory::reference_with_value<unsigned __int64>>(
			runtime.global_storage_->find_type(logic::type::primitive::convert_id_to_string(logic::type::primitive::id_type::nullptr_), false),
			0u,
			0ui64
		);
	case constant_type::nan_:
		return std::make_shared<memory::reference_with_value<constant_type>>(
			runtime.global_storage_->find_type(logic::type::primitive::convert_id_to_string(logic::type::primitive::id_type::nan_), false),
			0u,
			constant_type::nan_
		);
	default:
